% This code simulates the model figures in "Ramping and state uncertainty
% in the dopamine signal" by Mikhael, Kim, Uchida, & Gershman.
...
for iter = 1:numIter
    for y = 1:T+1
        ...
        w(T+1:end,3) = 1;               % value stays high until reward
    end
end
...
legend('True Value', 'Estimated Value', 'Location','Northwest')
legend('boxoff')
